...
public class Mapview extends FragmentActivity implements OnMapReadyCallback {
   ...
   /* View view;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //LatLng steveson = new LatLng(36.997035, -122.053060);
        LatLng steveson = new LatLng(v,v1);
        CameraUpdate point = CameraUpdateFactory.newLatLng(steveson);
        //mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(location.getLatitude(), location.getLongitude()), 12.0f));
        float zoom = 14;
        //mMap.moveCamera(point);
        // Add a marker in location and move the camera
        mMap.addMarker(new MarkerOptions().position(steveson).title(list.get(0)));
        mMap.animateCamera(point);
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(steveson, 16));
